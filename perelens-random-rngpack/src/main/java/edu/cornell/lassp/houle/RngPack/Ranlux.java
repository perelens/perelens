...
/**
	 * 
	 */
private static final long serialVersionUID = 2469858649757261542L;
...
public Ranlux(Ranlux toCopy) {
	this.BMoutput = toCopy.BMoutput;
	this.carry = toCopy.carry;
	this.diagOn = toCopy.diagOn;
	this.i24 = toCopy.i24;
	this.in24 = toCopy.in24;
	this.inseed = toCopy.inseed;
	this.j24 = toCopy.j24;
	this.jseed = toCopy.jseed;
	this.kount = toCopy.kount;
	this.mkount = toCopy.mkount;
	this.nskip = toCopy.nskip;
	this.twom12 = toCopy.twom12;
	this.twom24 = toCopy.twom24;
	
	this.isdext = toCopy.isdext;
	this.iseeds = toCopy.iseeds;
	this.next = toCopy.next;
	this.seeds = toCopy.seeds == null?null:Arrays.copyOf(toCopy.seeds, toCopy.seeds.length);
}
